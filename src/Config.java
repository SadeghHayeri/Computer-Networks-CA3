public class Config {
    ...
    public static final int MAX_SPLIT_SIZE = 50;
    public static final long TIMEOUT = 1;
    public static final byte[] PHANTON_BYTE = new byte[1];
    public static final long STARTING_THRESHOLD = 30;
    public static final int MSS = 5;
    public static final long MAX_DUPLICATE_ACK = 3;
}
